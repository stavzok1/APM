...
def match_sv_to_genes_from_vcfs(vcf_dir: str, genes_path: str, elements_path: str, lncRNAs_path: str, output_dir: str, sample_annotations_path: str) -> pd.DataFrame:
    ...
    from pipeline.tad_annotation.loader import annotate_svs_with_all_tad_sources
    ...
    for i,vcf_file in enumerate(os.listdir(vcf_dir)):
        ...
        strict_sv_set = annotate_svs_with_all_tad_sources(strict_sv_set, processed_dir=PATHS.tads_processed, biosamples=None, verbose=True)
