...
- **analyses (30):** `analyses/cptac/composition_pinpoint_lineage.py`, `analyses/outcome/outcome_mir200_deepdive.py`, `eval/_niter_bias_test.py`, `eval/_niter_floor_test.py`, `eval/_share_drift_check.py`, `eval/grid_oof.py`, `eval/within_family_showdown.py`, `learned/analyses/eb_shrink.py`, `learned/analyses/shrinkage_compare.py`, `learned/attribution_eb.py`, `learned/calibration.py`, `learned/card.py`, `learned/channel_cn.py`, `learned/confounders.py` …
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **29** findings · **41** modules
...
- **analyses (41):** `ago_gate.py`, `analyses/architecture/geneset_architecture.py`, `analyses/cnv_locus/sc_mirna_target_k562.py`, `analyses/edge_panels/edge_breast_context.py`, `analyses/edge_panels/edge_partial_corr_panels.py`, `analyses/edge_panels/edge_pressure_panels.py`, `analyses/edge_panels/edge_pressure_vs_corr_scatter.py`, `analyses/evidence_dev/evidence_scoring_sensitivity.py`, `analyses/misc/_oof_arm_vs_family_eiv.py`, `analyses/misc/compartment_annotate_network.py`, `analyses/misc/decoupling_validation.py`, `analyses/misc/escape_mechanism.py`, `analyses/misc/gene_force_concentration.py`, `analyses/misc/target_combined_anticorr.py` …
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **22** findings · **2** modules
...
- **analyses (2):** `eval/decoy_bench.py`, `learned/analyses/gene_atlas.py`
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **11** findings · **13** modules
...
- **analyses (13):** `analyses/dcis_ev/dcis_orphan_rigor.py`, `analyses/evidence_dev/orphan_noncircular_report.py`, `analyses/evidence_dev/orphan_noncircular_test.py`, `analyses/evidence_dev/orphan_noncircular_universe.py`, `analyses/mir301/mir301_family_depth.py`, `analyses/mir301/mir301_focus_genes.py`, `analyses/misc/mir301_family_network.py`, `eval/_e6_production_check.py`, `eval/targetscan_orphan_coupling.py`, `learned/analyses/enrichment.py`, `learned/discovery.py`, `learned/eval/retrofit.py`, `method_dev/site_ladder/discovery_site_evidence.py`
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **20** findings · **20** modules
...
- **analyses (20):** `analyses/cptac/composition_pinpoint_report.py`, `analyses/cptac/cptac_acquired_pressure.py`, `analyses/cptac/cptac_orphan_confound_pilot.py`, `analyses/cptac/cptac_orphan_discovery.py`, `analyses/cptac/cptac_orphan_evidence_table.py`, `analyses/cptac/cptac_resid_survivors.py`, `analyses/cptac/cptac_target_specificity.py`, `analyses/spatial/spatial_mibi_anchor.py`, `eval/buffa_validation.py`, `eval/coupling_grid.py`, `eval/cptac_validation.py`, `eval/grid_full.py`, `eval/protein_compartment_null.py`, `learned/cptac_data.py` …
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **15** findings · **11** modules
...
- **analyses (11):** `analyses/cnv_locus/cell_line_subtype_fidelity.py`, `analyses/misc/gene_expression_explainability.py`, `analyses/nmf/nmf_sample_signatures.py`, `analyses/nmf/within_subtype_signatures.py`, `learned/analyses/lineage_verdict.py`, `learned/subtype.py`, `pam50_gene_resolution.py`, `robustness_checks.py`, `stratum_characterization.py`, `subtype_contrasts.py`, `visibility_archetype_contrasts.py`
...
- **analyses (9):** `analyses/builders/_build_depmap_dependency.py`, `analyses/cnv_locus/ccle_breast_target_anticorr.py`, `analyses/cnv_locus/ccle_cn_expr_subtype_depth.py`, `analyses/cnv_locus/ccle_mirna_cn_concordance.py`, `analyses/outcome/outcome_buffa_pressure.py`, `analyses/outcome/outcome_escape_signature.py`, `analyses/outcome/outcome_metabric.py`, `analyses/pressure_dev/pressure_prognostic_improve.py`, `pressure_signature_curated_info.py`
...
- **status → verdict:** see [`STATE_OF_PLAY.md`](STATE_OF_PLAY.md) · **6** findings · **21** modules
...
- **analyses (21):** `analyses/dcis_ev/dcis_caf_nf_gse37527.py`, `analyses/dcis_ev/dcis_caf_tgfb_gse196354.py`, `analyses/dcis_ev/dcis_geo_loader.py`, `analyses/dcis_ev/dcis_htan_compartment.py`, `analyses/dcis_ev/dcis_lcm_compartment_gse162670.py`, `analyses/dcis_ev/dcis_mir29c_gse93740.py`, `analyses/dcis_ev/dcis_mrna_coupling.py`, `analyses/dcis_ev/dcis_risom_outcome_niche.py`, `analyses/dcis_ev/dcis_timing.py`, `analyses/dcis_ev/ev_mirna_301a_target_depth.py`, `analyses/dcis_ev/ev_mirna_deep.py`, `analyses/dcis_ev/ev_mirna_followup.py`, `analyses/dcis_ev/ev_mirna_gse255660_screen.py`, `analyses/dcis_ev/ev_mirna_gse270497_ts.py` …

## Shared / infrastructure  `shared`
*axis-agnostic loaders, builders, batch/CN helpers, and the retired-pressure builders — serve every axis*

- **modules (65):** `MIRACLE/make_miracle_figures.py`, `analyses/builders/_build_meth_chunked.py`, `analyses/builders/_build_tf_census.py`, `analyses/cnv_locus/mirna_locus_chr19_megacluster_gallery.py`, `analyses/cnv_locus/mirna_locus_sv_case_plots.py`, `analyses/edge_panels/edge_prior_refinement.py`, `analyses/evidence_dev/encori_evidence_sensitivity.py`, `analyses/evidence_dev/encori_mirtar_comparison.py`, `analyses/evidence_dev/encori_share_sensitivity.py`, `analyses/evidence_dev/fetch_encori_mrna.py`, `analyses/figures/make_grant_figure.py`, `analyses/figures/make_seed_grant_figures.py`, `analyses/misc/_oof_arm_vs_family_eiv2.py`, `analyses/misc/_oof_arm_vs_family_eiv3.py`, `analyses/misc/concordance_target_join.py`, `analyses/misc/genome_wide_promiscuity.py`, `analyses/misc/hub_gene_methylation.py`, `analyses/misc/spine_claim_audit.py`, `analyses/ops/axis_bootstrap.py`, `analyses/ops/gen_architecture.py` …
